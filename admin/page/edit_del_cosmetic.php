	...
	<tbody class="text-center">
		...
		<?php
			...
			<tr>
				...
				<td bgcolor="#fff" align="center"><img src="image_upload/new_cosmetic/<?php echo $row['photo']; ?>" height="150px" width="200px" /></td>
				<td bgcolor="#fff" align="center">
					<a class="btn btn-info" href="home.php?area=page&&action=cosmetic_edit&&id=<?php echo $row['id']; ?>" title="click for edit">Edit</a>
				
					<a class="btn btn-danger" href="home.php?area=page&&action=edit_del_cosmetic&&id=<?php echo $row['id']; ?>" title="click for delete" onclick="return confirm('sure to delete ?')">Delete</a>
				</td>
			</tr>
		<?php } ?>
		<script>
...
if(isset($_GET['id'])){	//checking wheather any request or not ?
	$del_id=$_GET['id'];
	mysql_query("DELETE FROM `new_cosmetic` WHERE `id`='$del_id'") or die(mysql_error());
	$_SESSION['msg']="Deleted Successfully";
	header('Location:home.php?area=page&&action=edit_del_cosmetic');
}
?>